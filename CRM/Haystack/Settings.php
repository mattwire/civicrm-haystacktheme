...
class CRM_Haystack_Settings {

  CONST TITLE = 'Haystack';
   ...
   * @param array $values Array of settings and values with or without prefix (eg. array(Haystack_username => 'test')) to save
   */
