...
return [
  ...
  'haystack_display_printlink' => [
    'admin_group' => 'haystack_tweak',
    'admin_grouptitle' => 'Tweaks',
    'admin_groupdescription' => 'Make changes to how/what CiviCRM displays',
    'group_name' => 'Haystack Settings',
    'group' => 'haystack',
    'name' => 'haystack_display_printlink',
    'type' => 'Boolean',
    'add' => '5.10',
    'is_domain' => 1,
    'is_contact' => 0,
    'default' => FALSE,
    'description' => 'Show the printer friendly link on CiviCRM pages.',
    'html_type' => 'Checkbox',
    'html_attributes' => [],
  ],
  'haystack_display_icallink' => [
    'admin_group' => 'haystack_tweak',
    'group_name' => 'Haystack Settings',
    'group' => 'haystack',
    'name' => 'haystack_display_icallink',
    'type' => 'Boolean',
    'add' => '5.10',
    'is_domain' => 1,
    'is_contact' => 0,
    'default' => FALSE,
    'description' => 'Show the iCal feed links on the event pages',
    'html_type' => 'Checkbox',
    'html_attributes' => [],
  ],
];
